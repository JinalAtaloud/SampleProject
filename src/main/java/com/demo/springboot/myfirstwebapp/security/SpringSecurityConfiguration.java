package com.demo.springboot.myfirstwebapp.security;
...
//InMemoryUserDetailsManager(UserDetails... users)
	...
	public InMemoryUserDetailsManager createUserDetailsManager() {
		...
		UserDetails userDetails1 = createNewUser("in28minutes", "dummy", passwordEncoder);
		UserDetails userDetails2 = createNewUser("jinal", "jinal", passwordEncoder);
